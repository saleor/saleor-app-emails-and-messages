...
export const EventConfigurationForm = ({
  ...
  useEffect(() => {
    fetchTemplatePreview({
      template: debouncedMutationVariables.template,
      subject: debouncedMutationVariables.subject,
      payload: debouncedMutationVariables.payload,
    });
  }, [JSON.stringify(debouncedMutationVariables), fetchTemplatePreview]);
